        ...
        <div className="max-w-3xl mx-auto space-y-12">
          <div>
            ...
            <div className="space-y-4 text-lg text-muted-foreground">
              <p>
                vibecheck exists because teenage guys deserve honest, straightforward advice about dating and relationships—without the toxic pickup artist bullshit or preachy lectures.
              </p>
              <p>
          ...
          <div>
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="text-muted-foreground">
                  No. We're not here to preach at you or make you feel like shit. We're here to give you real talk about what works and what doesn't. We frame things in terms of what's in YOUR best interest—because being respectful and having boundaries is actually better for you, not just "the right thing to do."
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
