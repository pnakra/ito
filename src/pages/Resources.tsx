        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <Card className="p-6 bg-card border-border hover:border-foreground/20 transition-colors">
              ...
              <Card className="p-6 bg-card border-border hover:border-foreground/20 transition-colors">
                <h3 className="text-xl font-bold mb-2">RAINN (Rape, Abuse & Incest National Network)</h3>
