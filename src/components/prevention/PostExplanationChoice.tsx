  ...
  return (
    <div className="animate-fade-in space-y-3 pt-6">
      ...
      <div className="flex gap-3">
        <button
          onClick={onContinue}
          className="flex-1 text-center border-[1.5px] border-warning/40 rounded-[12px] px-4 py-3 transition-all duration-150 active:scale-[0.98] hover:border-warning/60"
        >
